...
public class EventController {
    ...
    @PostMapping("edit")
    public String processEditForm(int eventId, String name, String email, String description,
                                  @ModelAttribute EventCategory eventCategory,
                                  @ModelAttribute EventDetails details){
